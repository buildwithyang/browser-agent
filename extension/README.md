...
网关地址可在扩展弹窗(popup)配置,存于 `chrome.storage.local.gatewayUrl`,默认 `http://127.0.0.1:17321`;云端填 `https://browser-agent.buildwithyang.com/api`。**使用前必须先启动 gateway**(见仓库根目录与 `gateway/` 的说明)。
