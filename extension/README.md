...
Side Panel 标题栏的“清空”只重置当前 owner/resource 的对话：保留 Quick Insight、
Shortcuts 和页面身份，清空 histories 以及由这些消息持有的 CV / Cover Letter Artifacts。
操作需要二次确认，生成期间不可执行，不会影响其他用户或页面的 Workspace。
